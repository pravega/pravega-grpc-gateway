...
_LISTSTREAMSREQUEST = _descriptor.Descriptor(
  ...
  full_name='ListStreamsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='scope', full_name='ListStreamsRequest.scope', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTSTREAMSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='ListStreamsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='scope', full_name='ListStreamsResponse.scope', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='stream', full_name='ListStreamsResponse.stream', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
ListStreamsRequest = _reflection.GeneratedProtocolMessageType('ListStreamsRequest', (_message.Message,), dict(
  ...
  __module__ = 'pravega.grpc_gateway.pravega_pb2'
  # @@protoc_insertion_point(class_scope:ListStreamsRequest)
  ))
...
ListStreamsResponse = _reflection.GeneratedProtocolMessageType('ListStreamsResponse', (_message.Message,), dict(
  ...
  __module__ = 'pravega.grpc_gateway.pravega_pb2'
  # @@protoc_insertion_point(class_scope:ListStreamsResponse)
  ))
...
_PRAVEGAGATEWAY = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='ListStreams',
    full_name='PravegaGateway.ListStreams',
    index=5,
    containing_service=None,
